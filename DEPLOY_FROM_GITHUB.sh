...
printf 'Products and database were preserved. Old AI keys were cleared.\n'
printf 'Next: run /opt/pricebot/SET_OPENROUTER_KEY.sh to enter your OpenRouter key securely.\n'
