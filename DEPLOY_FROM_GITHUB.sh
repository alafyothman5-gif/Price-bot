...
printf '=== PriceBot GitHub Deploy: Fast Final + Exact Match Hotfix ===\n'
printf 'Repo: %s\n' "$REPO_DIR"
printf 'App : %s\n' "$APP_DIR"
...
printf '\n3) Preserve existing AI keys/settings; do NOT reset OpenRouter key in this hotfix...\n'
echo 'AI keys preserved. Use CLEAN_AI_KEYS.sh manually only if you want to reset keys.'
...
printf 'Products, database, WhatsApp tokens, and existing OpenRouter key were preserved. Exact match hotfix applied.\n'
