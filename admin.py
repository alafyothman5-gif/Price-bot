...
<a href="/admin">الرئيسية</a><a href="/admin/analytics">الإحصائيات</a><a href="/admin/customer-link">رابط الزبائن/QR</a><a href="/admin/products">المنتجات</a><a href="/admin/orders">الطلبات</a><a href="/admin/failed-queries">الاستعلامات الفاشلة</a><a href="/admin/misses">Misses</a><a href="/admin/synonyms">Synonyms</a><a href="/admin/logout">خروج</a>
</div></div>
"""
