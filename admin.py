...
async def catalog_quality_xlsx(request: Request, _: bool = Depends(require_admin)):
    ...
    out = io.BytesIO()
    wb.save(out)
    return Response(content=out.getvalue(), media_type="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", headers={"Content-Disposition": "attachment; filename=catalog_quality_v17_4.xlsx"})
