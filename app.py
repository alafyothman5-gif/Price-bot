...
async def run_image_matching(phone: str, ai_data: dict, user_state: dict) -> str:
    ...
    for query in queries:
        ...
        try:
            ...
            log_event("MATCHER_V2_IMAGE_WARNING", error=exc)
...
async def lifespan(app: FastAPI):
    ...
    print("========================================")
    log_event("STARTING", version="stable-v13.2-db-guard-review-fix")
...
app = FastAPI(title="PriceBot / WhatsPrice Bot", version="stable-v13.2-db-guard-review-fix", lifespan=lifespan)
...
async def health_check():
    ...
    if now - float(health_cache.get("ts") or 0) > 30:
        health_cache["data"] = {
            ...
            "version": "stable-v13.2-db-guard-review-fix",
