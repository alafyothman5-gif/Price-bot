...
async def process_single_message(phone: str, msg_id: str, msg_type: str, msg: dict) -> None:
    ...
    try:
        ...
        log_event("QUERY_MISS_LOG_ERROR", error=exc)
...
async def lifespan(app: FastAPI):
    ...
    print("========================================")
    log_event("STARTING", version="stable-v13.1-matcher-v2-review-fix")
...
app = FastAPI(title="PriceBot / WhatsPrice Bot", version="stable-v13.1-matcher-v2-review-fix", lifespan=lifespan)
...
async def health_check():
    ...
    if now - float(health_cache.get("ts") or 0) > 30:
        health_cache["data"] = {
            ...
            "version": "stable-v13.1-matcher-v2-review-fix",
