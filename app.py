...
async def lifespan(app: FastAPI):
    ...
    print("========================================")
    log_event("STARTING", version="stable-v14.1-matcher-v3-eventloop-fix")
...
app = FastAPI(title="PriceBot / WhatsPrice Bot", version="stable-v14.1-matcher-v3-eventloop-fix", lifespan=lifespan)
...
async def health_check():
    ...
    if now - float(health_cache.get("ts") or 0) > 30:
        health_cache["data"] = {
            ...
            "version": "stable-v14.1-matcher-v3-eventloop-fix",
