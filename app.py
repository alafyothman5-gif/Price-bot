...
async def lifespan(app: FastAPI):
    ...
    print("========================================", flush=True)
    log_event("STARTING", version="stable-v17-final-strict-v4")
...
app = FastAPI(title="PriceBot / WhatsPrice Bot", version="stable-v17-final-strict-v4", lifespan=lifespan)
...
async def health_check():
    ...
    if now - float(health_cache.get("ts") or 0) > 30:
        ...
        health_cache["data"] = {
            ...
            "version": "stable-v17-final-strict-v4",
