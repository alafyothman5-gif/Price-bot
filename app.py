...
def _vision_prompt() -> str:
    ...
    return (
        "أنت نظام قراءة صور لواجهة صيدلية. أرجع JSON فقط بدون أي شرح. "
        "مهمتك قراءة النص الظاهر على علبة المنتج، وليس اختيار أقرب منتج عشوائياً. "
        ...
        "استخرج visible_text كما يظهر على الصورة. استخرج brand و product_type و size إن ظهرت. "
        "لا تخترع كلمات غير ظاهرة. لا تضع matched_product_names إلا إذا كان الاسم والنوع مطابقين بوضوح في الكتالوج. "
        "فرّق بدقة بين: cleanser/غسول/منظف، moisturizer/مرطب، cream/كريم، lotion/لوشن، serum/سيروم، sunscreen/واقي شمس، tablets/capsules/syrup/injection. "
        "إذا ظهر Cleanser أو Crème Lavante أو غسول أو منظف فهذا product_type=cleanser. لا تطابقه مع moisturizer أو cream أو lotion. "
        "إذا ظهر Moisturizing أو Moisturizer فقط فهذا product_type=moisturizer. "
        "إذا لم تكن متأكداً من المنتج اجعل confidence أقل من 0.55 ولا تخمن. "
        "الشكل المطلوب فقط: "
