...
async def lifespan(app: FastAPI):
    ...
    print("========================================")
    log_event("STARTING", version="stable-v15.1-final-safe-engine-index-cache")
    ...
    log_event("MATCHER_V3_INDEX_READY", value="YES", records=v3_records)
...
app = FastAPI(title="PriceBot / WhatsPrice Bot", version="stable-v15-final-safe-engine", lifespan=lifespan)
...
async def health_check():
    ...
    if now - float(health_cache.get("ts") or 0) > 30:
        ...
        health_cache["data"] = {
            ...
            "version": "stable-v15-final-safe-engine",
