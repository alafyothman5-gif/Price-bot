#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Compatibility acceptance tests for strict V4 resolver."""
from matcher_v4 import DecisionType, resolve_product_query, resolve_image_extraction, generate_catalog_quality_report
...
assert r.decision_type in {DecisionType.NOT_AVAILABLE, DecisionType.COSMETIC_ALTERNATIVES, DecisionType.IMAGE_UNCLEAR, DecisionType.LOW_CONFIDENCE}
...
assert r.decision_type in {DecisionType.NOT_AVAILABLE, DecisionType.IMAGE_UNCLEAR, DecisionType.LOW_CONFIDENCE} and not r.alternatives
